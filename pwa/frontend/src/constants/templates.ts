          ...
          groups: [
            {
              ...
              availableExercises: [
                ...
                { exerciseId: 'face-pull', exerciseName: '坐姿器械/绳索划船（水平开肘）', type: 'strength', targetSets: 4, targetReps: 15, order: 3 },
              ],
              selectedExercises: [],
            },
          ],
          ...
          groups: [
            {
              ...
              availableExercises: [
                ...
                { exerciseId: 'preacher-curl', exerciseName: '大师椅弯举', type: 'strength', targetSets: 4, targetReps: 10, order: 4 },
              ],
              selectedExercises: [],
            },
          ],
          ...
          groups: [
            ...
            },
            {
              ...
              availableExercises: [
                ...
                { exerciseId: 'cable-crossover-lower2', exerciseName: '龙门架夹胸（下斜夹）', type: 'strength', targetSets: 4, targetReps: 15, order: 1 },
          ...
          groups: [
            ...
            },
            {
              ...
              availableExercises: [
                ...
                { exerciseId: 'short-lunge', exerciseName: '短步蹲', type: 'strength', targetSets: 4, targetReps: 12, order: 2 },
