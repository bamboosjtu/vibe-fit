/*
  ...
  - You are about to drop the `BackupSnapshot` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `SyncMeta` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `User` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "BackupSnapshot" DROP CONSTRAINT "BackupSnapshot_userId_fkey";

-- DropForeignKey
ALTER TABLE "SyncMeta" DROP CONSTRAINT "SyncMeta_userId_fkey";

-- DropTable
DROP TABLE "BackupSnapshot";
