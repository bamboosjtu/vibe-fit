...
import { Box, Typography, TextField, Button, Paper, Alert, IconButton } from '@mui/material';
...
export function AuthPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await post<{ token: string; user: { id: string; email: string } }>(endpoint, {
        email,
        password,
      });
      ...
      setError(err instanceof Error ? err.message : '身份验证失败，请检查账号密码');
    } finally {
      setLoading(false);
    }
  };
